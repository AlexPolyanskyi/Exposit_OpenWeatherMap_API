 ...
 */
public class WeatherListFragmentAdapter extends RecyclerView.Adapter<WeatherListFragmentAdapter.MyViewHolder> {
    ...
    public WeatherListFragmentAdapter(Activity activity, List<? extends Weather> data, View view) {
    ...
    @Override
    public WeatherListFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(WeatherListFragmentAdapter.MyViewHolder holder, int position) {
